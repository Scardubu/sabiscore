...
const TEAM_LEAGUE_MAP: Record<string, string> = {
  ...
  // Eredivisie
  ajax: 'Eredivisie', afcajax: 'Eredivisie', ajaxamsterdam: 'Eredivisie',
  psv: 'Eredivisie', psveindhoven: 'Eredivisie',
  feyenoord: 'Eredivisie', feyenoordrotterdam: 'Eredivisie',
  azalkmaar: 'Eredivisie', az: 'Eredivisie',
  fctwente: 'Eredivisie', twente: 'Eredivisie', fctwenteenschede: 'Eredivisie',
  fcut: 'Eredivisie', fcutrecht: 'Eredivisie', utrecht: 'Eredivisie',
  vitesse: 'Eredivisie', vitessearnhem: 'Eredivisie',
  heerenveen: 'Eredivisie', scheerenveen: 'Eredivisie',
  goaheadeagles: 'Eredivisie', gae: 'Eredivisie',
  fortunasittard: 'Eredivisie', fortuna: 'Eredivisie',
  groningen: 'Eredivisie', fcgroningen: 'Eredivisie',
  nacbreda: 'Eredivisie', nac: 'Eredivisie',
  necnijmegen: 'Eredivisie', nec: 'Eredivisie',
  sparterotterdam: 'Eredivisie', sparta: 'Eredivisie', spartarotterdam: 'Eredivisie',
  rkcwaalwijk: 'Eredivisie', rkc: 'Eredivisie',
  almerecity: 'Eredivisie', almerecityfc: 'Eredivisie',
  excelsior: 'Eredivisie', excelsiorrotterdam: 'Eredivisie',
  heracles: 'Eredivisie', heraclesalmelo: 'Eredivisie',
  peczwolle: 'Eredivisie', pec: 'Eredivisie',
  willemii: 'Eredivisie', willem: 'Eredivisie',
}
